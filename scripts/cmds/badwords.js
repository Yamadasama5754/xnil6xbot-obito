module.exports = {
        config: {
                ...
                description: {
                        ...
                        ar: "تشغيل/إيقاف/إضافة/حذف تحذير الكلمات البذيئة، إذا خالف العضو سيتم تحذيره، وفي المرة الثانية سيتم طرده"
                },
                category: "المحادثة",
                guide: {
                        ...
                        ar: "   {pn} add <كلمات>: إضافة كلمات محظورة (يمكن إضافة كلمات متعددة مفصولة بفواصل)"
                                + "\n   {pn} delete <كلمات>: حذف كلمات محظورة"
                                + "\n   {pn} list <hide | فارغ>: عرض القائمة"
                                + "\n   {pn} unwarn [<userID> | <@tag>]: إزالة تحذير من عضو"
                                + "\n   {pn} on: تشغيل التحذير"
